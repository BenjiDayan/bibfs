...
// !!!! Benji: trying to define a new BFS??? This swaps every node. We base this of bfs_bi.hpp. Almost identical?
// Maybe we should just inherit... - as bfs_bi_balanced inherits from bfs_bi

class BFSBiNode : public BFSBi {
 public:
  BFSBiNode(unsigned n) : BFSBi(n) {};
